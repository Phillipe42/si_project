...
Product.create!(title: 'Autorretrato e Outras Cronicas',
  description:
    %{<p>
	  ...
	  condescendente autorretrato: "O sr. Carlos Drummond de Andrade e um razoavel 
...
Product.create!(title: 'Uma Forma de Saudade. Paginas de Diario',
  description:
    %{<p>
	  ...
	  organizador do volume, e sucedidas por uma seleta da poemas, as paginas 
	  revelam ao publico reflexoes do poeta acerca de familiares e amigos proximos 
...
Product.create!(title: 'Declaracao de Amor',
  description:
    %{<p>
	  ...
	  e grandes conhecedores de sua obra. O resultado e uma celebracao de beijos, 
